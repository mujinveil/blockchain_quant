...
from tools.huobiFuture.HuobiDMService import HuobiDM
...
SECRET_KEY = 'dd161fce-8c8695fe-569ccddd-08fd5'
...
print(u' 合约下单 ')
pprint(dm.send_contract_order(symbol='', contract_type='', contract_code='link-usdt',
                              client_order_id='', price='',volume=1, direction='buy',
